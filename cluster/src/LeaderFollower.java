...
public class LeaderFollower extends ClusteringAlgorithm {
    ...
    public LeaderFollower(double maxDis, Vector<float[]> trainData,
        ...
        // Now we put the clusters in a vector because we don't know in advance
